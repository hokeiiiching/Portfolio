...
export const Projects: React.FC = () => {
    ...
    return (
        <div className="h-full overflow-auto bg-cyber-bg p-6 font-mono">
            ...
            <div className="grid gap-4">
                {projects.map((project, index) => {
                    ...
                    return (
                        <article
                            key={index}
                            className={`
                bg-cyber-surface border ${colorClasses.border} rounded-lg p-5
              ...
              `}
                        >
                            ...
                            {/* Description */}
                            <p className="text-sm text-neon-cyan/70 mb-4 leading-relaxed">
                                {">"} {project.description}
                            </p>
            ...
            {/* Footer */}
            <div className="mt-6 text-center text-xs text-neon-cyan/30">
